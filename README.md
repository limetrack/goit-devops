...
### Крок 7: Доступ до Prometheus та Grafana

```bash
# Отримати доступ до Prometheus
kubectl port-forward -n monitoring svc/prometheus-kube-prometheus-prometheus 9090:9090

# Отримати доступ до Grafana
...
Monitoring stack автоматично розгортається з інфраструктурою та включає:

#### Компоненти:
- **Prometheus Server** - збір та зберігання метрик
...
- **Логін**: admin
- **Пароль**: admin123 (змінити в `modules/monitoring/values.yaml`)
- **Попередньо налаштовані дашборди**: Kubernetes кластер, Node Exporter, Prometheus

#### Persistent Storage:
- Prometheus: 10Gi (retention 30 днів)
- Grafana: 5Gi
- Alertmanager: 5Gi
- Усі дані зберігаються на EBS volumes
...
| Prometheus Stack | 55.5.0 | Моніторинг та метрики |
| Grafana | (включено в stack) | Візуалізація метрик |
